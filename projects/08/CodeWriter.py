...
class CodeWriter:
    ...
    def write_if(self, label: str) -> None:
        ...
        Args:
            label (str): the label to go to.
        """
        # read the condition result (-1 = true , 0 = false)
        # that because the last variable in the stack is the result of the given if condition
